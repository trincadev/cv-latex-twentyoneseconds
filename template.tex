...
\sidesection{
    ...
    It's possible to hide rows created with \textbackslash\texttt{makeinfoprofile} command leaving the macros empty (e.g. \textbackslash\texttt{cvsitepersonal\{\}} instead than \textbackslash\texttt{cvsitepersonal\{example.com\}}).}
    \customsidesection{It's possible to hide the profile picture changing \textbackslash\texttt{makeheaderprofilenoimg} with \textbackslash\texttt{makeheaderprofilenoimg}, then is possible to remove \textbackslash\texttt{profilepic\{image.png\}}).
